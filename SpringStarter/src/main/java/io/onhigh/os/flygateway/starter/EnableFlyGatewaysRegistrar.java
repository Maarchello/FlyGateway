...
@Slf4j
@Setter
public class EnableFlyGatewaysRegistrar implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, EnvironmentAware {
...
//        );
    ...
    public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        ...
        Map<String, Object> enableApiAttributes = metadata.getAnnotationAttributes(EnableFlyGateway.class.getCanonicalName());
